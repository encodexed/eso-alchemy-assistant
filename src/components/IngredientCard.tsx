...
const IngredientCard = ({ data }: Props) => {
  ...
  return (
    <div
      ...
      className="my-0.5 flex w-full cursor-pointer items-center gap-2 border border-gray-200 py-1 shadow-sm hover:border-red-400 hover:shadow-md hover:shadow-red-200"
    >
